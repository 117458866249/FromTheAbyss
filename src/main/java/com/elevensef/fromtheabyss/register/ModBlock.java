...
import com.elevensef.fromtheabyss.custom.block.AbyssAnchorTemp;
...
public class ModBlock {
    ...
    public static final RegistryObject<Block> ABYSS_ALLOY_BLOCK_B = BLOCKS.register("abyss_alloy_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE)
                    .strength(1.2f,3.2f)
                    .requiresCorrectToolForDrops()));
    public static final RegistryObject<Item> ABYSS_ALLOY_BLOCK = ModItem.ITEMS.register("abyss_alloy_block",
            () -> new BlockItem(ABYSS_ALLOY_BLOCK_B.get(), new Item.Properties()));



    public static final RegistryObject<Block> ABYSS_ANCHOR_TEMP_B = BLOCKS.register("abyss_anchor_temp",
            () -> new AbyssAnchorTemp(BlockBehaviour.Properties.copy(Blocks.BEDROCK)));
    public static final RegistryObject<Item> ABYSS_ANCHOR_TEMP = ModItem.ITEMS.register("abyss_anchor_temp",
            () -> new BlockItem(ABYSS_ANCHOR_TEMP_B.get(), new Item.Properties()));
